...
public class SqliteActivity extends AppCompatActivity {
        ...
        btnDelete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (deletedRows > 0) {
                    ...
                    Toast.makeText(SqliteActivity.this, "Data not deleted", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
    public void updateData(){
            ...
            public void onClick(View v){
                ...
                if (isUpdate){
                    Toast.makeText(SqliteActivity.this,"Data Updated",Toast.LENGTH_LONG).show();
    ...
    public void addData(){
        btnAddData.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v){
                ...
                if (isInserted){
                    Toast.makeText(SqliteActivity.this,"Data Added",Toast.LENGTH_LONG).show();

                }else{
                    Toast.makeText(SqliteActivity.this,"Data not Added",Toast.LENGTH_LONG).show();
                }
            }
    });
}
